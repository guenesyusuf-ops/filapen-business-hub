...
export const CONTENT_TYPE_COLORS: Record<string, string> = {
  ...
  ugc_script: 'bg-amber-100 text-amber-700',
  video_concept: 'bg-orange-100 text-orange-700',
  ...
  social_caption: 'bg-blue-100 text-blue-700',
};
